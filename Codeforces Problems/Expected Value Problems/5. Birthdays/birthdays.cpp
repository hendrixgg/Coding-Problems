...
/*
You teach informatics in a class with 20 students. When someone has a birthday, you must let the whole class to play 
games instead of learning algorithms and using Excel. Maybe some students have birthday on the same day, so there 
...
int main()
{
    ...
    cout << 365*(1.0 - pow(364.0/365.0, 20)) << nl;
